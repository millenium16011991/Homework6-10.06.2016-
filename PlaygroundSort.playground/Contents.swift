...
var sortOfAgeDriver1 = persons.sort {$0.age < $1.age}
sortOfAgeDriver1

var sortOfAgeDriver2 = cars.sort {$0.driver.age < $1.driver.age}
sortOfAgeDriver2

var sortOfAgeDriverBecome1 = persons.sort {$0.age > $1.age}
sortOfAgeDriverBecome1

var sortOfAgeDriverBecome2 = cars.sort {$0.driver.age > $1.driver.age}
sortOfAgeDriverBecome2
